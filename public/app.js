...
/***/ function(module, exports, __webpack_require__) {
	...
	var pick = __webpack_require__(2);
	var assign = __webpack_require__(26);
	var orderBy = __webpack_require__(41);

	var cache = __webpack_require__(131);
	...
	function users(username) {
	    ...
	    var starredUrl = baseUrl + '/users/' + usernameEncoded +'/starred';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseOrderBy = __webpack_require__(42),
	    isArray = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var checkGlobal = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router = __webpack_require__(133);
	var data = __webpack_require__(134);


	var OrgSummary = __webpack_require__(135);
	var UserList = __webpack_require__(137);
	var UserDetail = __webpack_require__(139);
	...
	var App = React.createClass({
	  ...
	  getStateByLocation: function () {
	    ...
	    console.log('prev route', oldRoute, newRoute);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createFactory(function (props) {
	  ...
	  var name = React.createElement('div', { className: 'text-large' }, props.name || props.login);
	  var location = React.createElement('div', { }, props.location);
	...
	// "https://avatars.githubusercontent.com/u/1091054?v=3"
	// blog
	// :
	// "http://code42.github.com"
	// company
	// :
	// null
	// created_at
	// :
	// "2011-09-29T21:00:29Z"
	// description
	// :
	// ""
	// email
	...
	// events_url
	// :
	// "https://api.github.com/orgs/code42/events"
	// followers
	// :
	// 0
	// following
	...
	// hooks_url
	// :
	// "https://api.github.com/orgs/code42/hooks"
	// html_url
	// :
	...
	// issues_url
	// :
	// "https://api.github.com/orgs/code42/issues"
	// location
	// :
	// "Minneapolis, MN"
	// login
	...
	// members_url
	// :
	// "https://api.github.com/orgs/code42/members{/member}"
	// name
	// :
	// "Code42 Software"
	// public_gists
	...
	// public_members_url
	// :
	// "https://api.github.com/orgs/code42/public_members{/member}"
	// public_repos
	// :
	// 4
	// repos_url
	// :
	// "https://api.github.com/orgs/code42/repos"
	// type
	// :
	// "Organization"
	// updated_at
	// :
	// "2016-01-15T19:09:48Z"
	// url
	// :
	// "https://api.github.com/orgs/code42"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserLink = __webpack_require__(138);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Avatar = __webpack_require__(136);
	var RepoList = __webpack_require__(140);
	  ...
	  if (!props.user) {
	    return React.createElement('div', { className: 'panel' }, [
	      React.createElement('div', { className: 'blankslate blankslate-spacious' }, [
	        React.createElement('h3', { }, ['Select a member' ]),
	      ])
	    ]);
	  }
